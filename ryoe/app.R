    ...
    navbarPage("By Tej Seth at PFF",
               tabPanel("By Season",
                        fluidRow(
                          column(4, align = "center",
                                 sliderInput("year_range", "Year Range", value = c(2021, 2022), min = 2008, max = 2022, sep = ""),
                          ),
                          column(7, align = "center",
                                 sliderInput("min_rushes", "Minimum Rushes", value = 120, min = 10, max = 1000),
                          ),
                          mainPanel(
               ...
               tabPanel('Rusher Comparison',
                        fluidRow(
                          ...
                          column(4, align = "center", 
                                 sliderInput("range_years", "Year Range", value = c(2019, 2022), min = 2008, max = 2022, sep = ""),
